...
- (void)mal_asyncEnumerateObjectsUsingBlock:(void (^)(ObjectType obj, NSUInteger idx, BOOL isLast, dispatch_block_t next))block;

//- (void)mal_asyncEnumerateBatchesUsingBlock:(void (^)(NSArray<ObjectType> *batch, NSUInteger idx, BOOL isLast, void (^nextBatch)(NSUInteger count)))block;
