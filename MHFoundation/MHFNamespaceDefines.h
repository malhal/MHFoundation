...
//  MHFoundation
//
//  Generated using MHNamespaceGenerator on 03/09/2016
//
...
// Categories
    ...
    #define mhf_acceptJSON __MHFOUNDATION_NS_SYMBOL(mhf_acceptJSON)
    ...
    #define mhf_contentTypeJSON __MHFOUNDATION_NS_SYMBOL(mhf_contentTypeJSON)
    ...
    #define mhf_methodPOST __MHFOUNDATION_NS_SYMBOL(mhf_methodPOST)
